...
Roraima soma 425 registros e R$ 1.862.959.003,89 em valor total. No ranking geral da base, a UF esta em 18o lugar por valor, 22o por quantidade de registros, 2o por ticket medio e 2o por concentracao dos 5 maiores beneficiarios.

O perfil dominante da UF e ticket medio e concentracao. O ticket medio e de R$ 4.383.432,95, a mediana e de R$ 1.200.410,31 e os 5 maiores beneficiarios concentram 96,6% do valor total.
...
Comparando com o conjunto nacional, RR aparece entre as UFs lideres por valor em `PR, SP, PB, MS, SE`, por volume em `SE, PB, PR, MG, RS`, por ticket medio em `PE, RR, RJ, AM, AC` e por concentracao em `AC, RR, PR, CE, PE`.
...
Termos mais frequentes nos objetos da UF: `RORAIMA, MUNICIPIO, AQUISICAO, CONSTRUCAO, SAUDE, VISTA, UNIDADE, EQUIPAMENTOS, ACOES, ATENCAO, MILITAR, REFORMA`.
...
1. `2024` - R$ 351.511.276,88 em 50 registros.
...
- `2022`: R$ 168.266.002,15 em 22 registros, variacao 4,9%.
- `2023`: R$ 196.170.129,66 em 42 registros, variacao 16,6%.
- `2024`: R$ 351.511.276,88 em 50 registros, variacao 79,2%.
- `2025`: R$ 5.302.840,88 em 5 registros, variacao -98,5%.
...
2. `IRACEMA` - R$ 749.870,61 em 5 registros.
3. `CANTA` - R$ 730.007,00 em 2 registros.
4. `CARACARAI` - R$ 635.000,00 em 4 registros.
5. `SAO JOAO DA BALIZA` - R$ 121.000,00 em 1 registros.

Cobertura observada: CNPJ valido em 100,0%, municipio em 100,0%, objeto em 100,0% e modalidade em 100,0%. Ha 0 registros negativos e 5 registros marcados como duplicado aparente.
