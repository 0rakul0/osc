...
Santa Catarina soma 2.380 registros e R$ 1.473.046.529,75 em valor total. No ranking geral da base, a UF esta em 20o lugar por valor, 17o por quantidade de registros, 15o por ticket medio e 23o por concentracao dos 5 maiores beneficiarios.
...
Comparando com o conjunto nacional, SC aparece entre as UFs lideres por valor em `PR, SP, PB, MS, SE`, por volume em `SE, PB, PR, MG, RS`, por ticket medio em `PE, RR, RJ, AM, AC` e por concentracao em `AC, RR, PR, CE, PE`.
