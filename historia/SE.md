...
Sergipe soma 175.232 registros e R$ 33.038.111.310,94 em valor total. No ranking geral da base, a UF esta em 5o lugar por valor, 1o por quantidade de registros, 26o por ticket medio e 20o por concentracao dos 5 maiores beneficiarios.
...
Comparando com o conjunto nacional, SE aparece entre as UFs lideres por valor em `PR, SP, PB, MS, SE`, por volume em `SE, PB, PR, MG, RS`, por ticket medio em `PE, RR, RJ, AM, AC` e por concentracao em `AC, RR, PR, CE, PE`.

Na pratica, isso indica que Sergipe cresce principalmente por volume de dados. A participacao da UF no total nacional desta pasta e de 9,0%.
